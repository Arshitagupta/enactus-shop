    ...
    <Container>
      ...
      <Wrapper>
        ...
        <Top>
          ...
          <TopButton type="filled" onClick={handleSubmit}>UPLOAD CART</TopButton>
          <TopButton type="filled" onClick={()=>handleClick({},"r")}>CHECKOUT NOW</TopButton>
        </Top>
        <Bottom>
          <Info>
